...
import { Sparkles, AlertCircle, ArrowLeft, FileBadge } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
        <div className="relative mb-6">
          ...
          <div className="relative w-20 h-20 rounded-3xl bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/50 flex items-center justify-center text-blue-600 dark:text-blue-400 shadow-md">
            <FileBadge className="w-10 h-10 text-blue-600 dark:text-blue-500" />
          </div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400 text-sm max-w-sm leading-relaxed mb-8">
          Chúng tôi đang tích cực xây dựng phân hệ <strong className="font-bold text-zinc-800 dark:text-zinc-200">Xác thực Sinh viên</strong> này. Trải nghiệm tuyệt vời sẽ sớm ra mắt!
        </p>

        <Link 
          href="/" 
          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 active:scale-98 text-white px-5 py-2.5 rounded-xl text-xs font-bold shadow-md shadow-blue-500/10 transition-all cursor-pointer"
        >
